...
void main()
{
    ...
    u_xlat10_0.x = texture2D(_Illum, vs_TEXCOORD0.zw).w;
    SV_Target0.xyz = u_xlat16_3.xyz * u_xlat10_0.xxx + u_xlat16_2.xyz;
    SV_Target0.w = 1.0;
    return;
}
...
void main()
{
    ...
    u_xlat16_2.xyz = vec3(u_xlat0) * _LightColor0.xyz;
    u_xlat16_1.xyz = u_xlat16_1.xyz * u_xlat16_2.xyz;
...
void main()
{
    ...
    u_xlat16_2.xyz = u_xlat16_1.xyz * vs_TEXCOORD4.xyz;
    u_xlat10_0.x = texture2D(_Illum, vs_TEXCOORD0.zw).w;
    SV_Target3.xyz = u_xlat16_1.xyz * u_xlat10_0.xxx + u_xlat16_2.xyz;
    SV_Target3.w = 1.0;
    return;
}
